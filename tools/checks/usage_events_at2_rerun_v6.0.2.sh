...
echo "$today,12:00:00,ACTIVITY_RESUMED,com.test.a" >> "$raw"
echo "$today,12:05:00,ACTIVITY_PAUSED,com.test.a"  >> "$raw"
echo "$today,13:00:00,ACTIVITY_RESUMED,com.test.b" >> "$raw"
echo "$today,13:05:00,ACTIVITY_PAUSED,com.test.b"  >> "$raw"
IN
