...
OUT="evidence/v6.0/notification_engagement/ee4.1.txt"
mkdir -p "$(dirname "$OUT")"
...
ALLOW_GREP="$(grep -E '^( !evidence/|!evidence/|!evidence/v6\.0/|!evidence/v6\.0/notification_engagement/|!evidence/.+\\)' .gitignore || true)"
...
check_not_ignored "evidence/v6.0/notification_engagement/"
check_not_ignored "evidence/v6.0/notification_engagement/ee4.1.txt"
)"
