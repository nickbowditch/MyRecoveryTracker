...
OUT="evidence/v6.0/usage_events/ee4.1.txt"
mkdir -p "$(dirname "$OUT")"
...
ALLOW_GREP="$(grep -E '^( !evidence/|!evidence/|!evidence/v6\.0/|!evidence/v6\.0/usage_events/|!evidence/.+\\)' .gitignore || true)"
...
check_not_ignored "evidence/v6.0/usage_events/"
check_not_ignored "evidence/v6.0/usage_events/ee4.1.txt"
)"
