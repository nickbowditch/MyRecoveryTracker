...
OUT="evidence/v6.0/notification_latency/tc5.1.txt"
...
[ "$HDR" = "date,feature_schema_version,p50_ms,p90_ms,p99_ms,count" ] || { echo "TC-5 RESULT=FAIL (bad header)" | tee "$OUT"; exit 5; }
