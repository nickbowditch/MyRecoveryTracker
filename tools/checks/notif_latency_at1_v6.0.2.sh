...
adb shell am broadcast -a com.nick.myrecoverytracker.ACTION_RUN_NOTIFICATION_LATENCY_ROLLUP -n com.nick.myrecoverytracker/.TriggerReceiver >/dev/null 2>&1 || fail "(broadcast failed)"
sleep 2
