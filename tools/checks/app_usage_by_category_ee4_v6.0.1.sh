...
OUT="evidence/v6.0/app_usage_by_category/ee4.1.txt"
mkdir -p "$(dirname "$OUT")"
...
ALLOW_GREP="$(grep -E '^( !evidence/|!evidence/|!evidence/v6\.0/|!evidence/v6\.0/app_usage_by_category/|!evidence/.+\\)' .gitignore || true)"
...
check_not_ignored "evidence/v6.0/app_usage_by_category/"
check_not_ignored "evidence/v6.0/app_usage_by_category/ee4.1.txt"
)"
