...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m544boximpl(short[] sArr) {
        return new UShortArray(sArr);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short[] m546constructorimpl(short[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m549equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual(sArr, ((UShortArray) obj).getStorage());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m550equalsimpl0(short[] sArr, short[] sArr2) {
    ...
    public static int m553hashCodeimpl(short[] sArr) {
        return Arrays.hashCode(sArr);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m557toStringimpl(short[] sArr) {
    ...
    public boolean m558addxj2QHRw(short s) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static short[] m545constructorimpl(int size) {
        return m546constructorimpl(new short[size]);
    }

    /* renamed from: get-Mh2AYeg, reason: not valid java name */
    public static final short m551getMh2AYeg(short[] arg0, int index) {
        return UShort.m493constructorimpl(arg0[index]);
    }

    /* renamed from: set-01HTLdE, reason: not valid java name */
    public static final void m556set01HTLdE(short[] arg0, int index, short value) {
        arg0[index] = value;
    }

    /* renamed from: getSize-impl, reason: not valid java name */
    public static int m552getSizeimpl(short[] arg0) {
        return arg0.length;
    }
    ...
    public static java.util.Iterator<UShort> m555iteratorimpl(short[] arg0) {
    ...
    private static final class Iterator implements java.util.Iterator<UShort>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UShort next() {
            return UShort.m487boximpl(m561nextMh2AYeg());
        }
        ...
        public short m561nextMh2AYeg() {
            ...
            int i = this.index;
            this.index = i + 1;
            return UShort.m493constructorimpl(sArr[i]);
        }
    }

    /* renamed from: contains-xj2QHRw, reason: not valid java name */
    public boolean m559containsxj2QHRw(short element) {
        return m547containsxj2QHRw(this.storage, element);
    }

    /* renamed from: contains-xj2QHRw, reason: not valid java name */
    public static boolean m547containsxj2QHRw(short[] arg0, short element) {
    ...
    public static boolean m548containsAllimpl(short[] arg0, Collection<UShort> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m554isEmptyimpl(short[] arg0) {
