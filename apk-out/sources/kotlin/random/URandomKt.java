...
public final class URandomKt {
    public static final int nextUInt(Random $this$nextUInt) {
        ...
        return UInt.m307constructorimpl($this$nextUInt.nextInt());
    }

    /* renamed from: nextUInt-qCasIEU, reason: not valid java name */
    public static final int m1432nextUIntqCasIEU(Random nextUInt, int until) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        return m1431nextUInta8DCA5k(nextUInt, 0, until);
    }

    /* renamed from: nextUInt-a8DCA5k, reason: not valid java name */
    public static final int m1431nextUInta8DCA5k(Random nextUInt, int from, int until) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        m1426checkUIntRangeBoundsJ1ME1BU(from, until);
        ...
        return UInt.m307constructorimpl(signedResult);
    }
    ...
    public static final int nextUInt(Random $this$nextUInt, UIntRange range) {
        ...
        return Integer.compare(range.getLast() ^ Integer.MIN_VALUE, (-1) ^ Integer.MIN_VALUE) < 0 ? m1431nextUInta8DCA5k($this$nextUInt, range.getFirst(), UInt.m307constructorimpl(range.getLast() + 1)) : Integer.compare(range.getFirst() ^ Integer.MIN_VALUE, 0 ^ Integer.MIN_VALUE) > 0 ? UInt.m307constructorimpl(m1431nextUInta8DCA5k($this$nextUInt, UInt.m307constructorimpl(range.getFirst() - 1), range.getLast()) + 1) : nextUInt($this$nextUInt);
    }

    public static final long nextULong(Random $this$nextULong) {
        Intrinsics.checkNotNullParameter($this$nextULong, "<this>");
        return ULong.m386constructorimpl($this$nextULong.nextLong());
    }

    /* renamed from: nextULong-V1Xi4fY, reason: not valid java name */
    public static final long m1433nextULongV1Xi4fY(Random nextULong, long until) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        return m1434nextULongjmpaWc(nextULong, 0L, until);
    }

    /* renamed from: nextULong-jmpaW-c, reason: not valid java name */
    public static final long m1434nextULongjmpaWc(Random nextULong, long from, long until) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        m1427checkULongRangeBoundseb3DHEI(from, until);
        ...
        return ULong.m386constructorimpl(signedResult);
    }
    ...
    public static final long nextULong(Random $this$nextULong, ULongRange range) {
        ...
        if (Long.compare(range.getLast() ^ Long.MIN_VALUE, (-1) ^ Long.MIN_VALUE) < 0) {
            return m1434nextULongjmpaWc($this$nextULong, range.getFirst(), ULong.m386constructorimpl(range.getLast() + ULong.m386constructorimpl(1 & 4294967295L)));
        }
        if (Long.compare(range.getFirst() ^ Long.MIN_VALUE, 0 ^ Long.MIN_VALUE) <= 0) {
            return nextULong($this$nextULong);
        }
        long j = 1 & 4294967295L;
        return ULong.m386constructorimpl(m1434nextULongjmpaWc($this$nextULong, ULong.m386constructorimpl(range.getFirst() - ULong.m386constructorimpl(j)), range.getLast()) + ULong.m386constructorimpl(j));
    }
    ...
    public static final byte[] nextUBytes(Random $this$nextUBytes, int size) {
        ...
        return UByteArray.m283constructorimpl($this$nextUBytes.nextBytes(size));
    }
    ...
    public static final byte[] m1429nextUBytesWvrt4B4(Random nextUBytes, byte[] array, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter(nextUBytes, "$this$nextUBytes");
        Intrinsics.checkNotNullParameter(array, "array");
    ...
    public static final void m1426checkUIntRangeBoundsJ1ME1BU(int from, int until) {
        if (!(Integer.compare(until ^ Integer.MIN_VALUE, from ^ Integer.MIN_VALUE) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(UInt.m301boximpl(from), UInt.m301boximpl(until)).toString());
        }
    }

    /* renamed from: checkULongRangeBounds-eb3DHEI, reason: not valid java name */
    public static final void m1427checkULongRangeBoundseb3DHEI(long from, long until) {
        if (!(Long.compare(until ^ Long.MIN_VALUE, from ^ Long.MIN_VALUE) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(ULong.m380boximpl(from), ULong.m380boximpl(until)).toString());
        }
    }
}
