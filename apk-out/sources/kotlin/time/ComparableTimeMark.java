...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1529minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo1530minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1531plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1533minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo1531plusLRDsOJo(Duration.m1591unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1537compareToLRDsOJo($this.mo1530minusUwyO8pc(other), Duration.INSTANCE.m1641getZEROUwyO8pc());
        }
    }
}
