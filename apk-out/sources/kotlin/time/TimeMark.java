...
public interface TimeMark {
    ...
    TimeMark mo1529minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1531plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1676plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1675minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1531plusLRDsOJo(Duration.m1591unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1571isNegativeimpl($this.mo1528elapsedNowUwyO8pc());
        }
