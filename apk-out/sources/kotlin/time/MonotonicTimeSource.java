...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1678boximpl(m1672markNowz9LOYto());
    }
    ...
    public long m1672markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1681constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1671elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1670differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m1669adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1681constructorimpl(LongSaturatedMathKt.m1667saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
