...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C00521<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C00521(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C00521> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00521 c00521 = new C00521(this.$this_ifEmpty, this.$defaultValue, continuation);
            c00521.L$0 = obj;
            return c00521;
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C00521(sequence, defaultValue, null));
    }
    ...
    static final class C00531<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00531(Sequence<? extends T> sequence, Random random, Continuation<? super C00531> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00531 c00531 = new C00531(this.$this_shuffled, this.$random, continuation);
            c00531.L$0 = obj;
            return c00531;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C00531) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c00531.$random.nextInt(mutableList.size());
                ...
                c00531.L$0 = sequenceScope;
                c00531.L$1 = mutableList;
                c00531.label = 1;
                if (sequenceScope.yield(objRemoveLast, c00531) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C00531(sequence, random, null));
    }
    ...
    static final class C00481<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00481(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C00481> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00481 c00481 = new C00481(this.$source, this.$transform, this.$iterator, continuation);
            c00481.L$0 = obj;
            return c00481;
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            while (it.hasNext()) {
                ...
                Function2<Integer, T, C> function2 = c00481.$transform;
                int index2 = index + 1;
                if (index < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                Object result = function2.invoke(Boxing.boxInt(index), element);
                c00481.L$0 = $this$sequence;
                c00481.L$1 = it;
                c00481.I$0 = index2;
                c00481.label = 1;
                if ($this$sequence.yieldAll(c00481.$iterator.invoke(result), c00481) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                index = index2;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C00481(source, transform, iterator, null));
    }
