...
public abstract class FileSystem {
    ...
    public static /* synthetic */ Object m1930write$default(FileSystem $this, Path file, boolean mustCreate, Function1 writerAction, int i, Object obj) throws Throwable {
        if (obj == null) {
            if ((i & 2) != 0) {
                mustCreate = false;
            }
    ...
    public final <T> T m1931read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws Throwable {
        Intrinsics.checkNotNullParameter(file, "file");
    ...
    public final <T> T m1932write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws Throwable {
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
