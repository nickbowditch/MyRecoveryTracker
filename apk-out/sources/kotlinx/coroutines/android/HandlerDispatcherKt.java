...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM212constructorimpl = Result.m212constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM212constructorimpl = Result.m212constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m218isFailureimpl(objM212constructorimpl) ? null : objM212constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo1771dispatch(cont.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
