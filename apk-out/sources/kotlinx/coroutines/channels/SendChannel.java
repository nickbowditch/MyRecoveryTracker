...
public interface SendChannel<E> {
    ...
    Object mo1715trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1715trySendJP2dKIU(e);
            if (ChannelResult.m1735isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1729exceptionOrNullimpl = ChannelResult.m1729exceptionOrNullimpl(result);
