...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM212constructorimpl = Result.m212constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM212constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    ...
                    objM212constructorimpl = Result.m212constructorimpl((Intrinsics.areEqual(e.getMessage(), result.getMessage()) || Intrinsics.areEqual(result.getMessage(), e.toString())) ? result : null);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM212constructorimpl = Result.m212constructorimpl(ResultKt.createFailure(th));
                }
                return (Throwable) (Result.m218isFailureimpl(objM212constructorimpl) ? null : objM212constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM212constructorimpl = Result.m212constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM212constructorimpl = Result.m212constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m218isFailureimpl(objM212constructorimpl)) {
            objM212constructorimpl = numValueOf;
        }
        return ((Number) objM212constructorimpl).intValue();
    }
